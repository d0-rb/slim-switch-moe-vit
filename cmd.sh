...
read -p 'lr' lr
CUDA_VISIBLE_DEVICES=$cuda python main.py --model $model --data-set CIFAR10 --data-path ./dataset --batch 198\
                ...
                --output_dir cifar-models/$model/scratch_${starting_threshold}_${target_threshold}_${lr}/$n\
