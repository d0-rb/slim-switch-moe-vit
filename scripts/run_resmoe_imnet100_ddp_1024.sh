...
CUDA_VISIBLE_DEVICES=$cuda python -m torch.distributed.launch --nproc_per_node=$num_cuda --master_port=$port --use_env \
                ...
                --output_dir logs/${dataset}/${model}/scratch/lr_${lr}_ep_${epochs}_bs_${batchsize}/cosine/dense_${start_threshold}_${target_threshold}/moe_${start_threshold}_${target_threshold}/${n}
