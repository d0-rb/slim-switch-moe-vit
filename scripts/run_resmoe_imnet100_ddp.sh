...
port="1234"
model="resmoe_tiny_patch16_224_expert8_imnet_v4"
lr="3e-4"
start_threshold="1.0"
...
NCCL_P2P_DISABLE=1 CUDA_VISIBLE_DEVICES=$cuda torchrun --nproc_per_node=$num_cuda --master_port=$port main.py --model $model --data-set $dataset \
                ...
                --output_dir results/${dataset}/${model}/scratch/lr_${lr}_ep_${epochs}/cosine/dense_${start_threshold}_${target_threshold}/moe_${start_threshold}_${target_threshold}/${n}
