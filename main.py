...
from threshold_scheduler import ConstantLR, LinearLR, CosineAnnealingLR
...
def get_args_parser():
    ...
    # parser.add_argument(
    #     "--cosine-end-threshold",
    #     default=0.0,
    #     type=float,
    #     help="Minimum learning rate",
    # )
    # Config for linear scheduler
    #https://pytorch.org/docs/stable/generated/torch.optim.lr_scheduler.LinearLR.html#torch.optim.lr_scheduler.LinearLR
    # parser.add_argument(
    #     "--linear-start-factor",
    #     default=0.3333333333333333,
    #     type=float,
    #     help="The number we multiply learning rate in the first epoch. The multiplication factor changes towards end_factor in the following epochs.",
    # )
    # parser.add_argument(
    #     "--linear-end-factor",
    #     default=1.0,
